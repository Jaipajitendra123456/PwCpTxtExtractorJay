...
API_ID = int(os.environ.get("API_ID", 29257881))
API_HASH = os.environ.get("API_HASH", "3dd9f4e0716871e4b507f9411fd1ee8b")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8017376520:AAE3FZuQmwezAs5PcniD0gX6FCz8krqA9bI")
